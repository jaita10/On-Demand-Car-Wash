...
const Home = (props) => {
  return (
    <div className="mx-2 rounded-5" style={{ height: '60vh', backgroundImage: `url("./carwash_main.jpg")`, backgroundSize: '60%' , backgroundRepeat: 'no-repeat' , backgroundPosition: 'right' , marginTop: '7%'}}>
